...
class UserProfile extends Component {
  ...
  async handleClick(e) {
    ...
    try {
      ...
      if (AuthService.getJsonItemValue("email")) {
        //   alert(AuthService.getJsonItemValue("email"));
        /*  const email = AuthService.getJsonItemValue("email");
        const username = AuthService.getJsonItemValue("username"); */
      }
